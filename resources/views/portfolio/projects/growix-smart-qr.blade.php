        ...
        <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
            <nav class="flex mb-8" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-sm ">
                    ...
                    <li><x-icons.chevron-right class="w-4 h-4" /></li>
                    <li class=" font-medium">Growix: Smart QR</li>
                </ol>
            </nav>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <a href="{{ route('portfolio.kifayat-card') }}"
                    ...
                    <div class="p-8">
                        ...
                        <p class=" text-sm">Merchant loyalty ledger system with secure QR code scanners.</p>
                    </div>
                </a>
                <a href="{{ route('portfolio.attendance-manager') }}"
                    ...
                    <div class="p-8">
                        ...
                        <p class=" text-sm">Employee geolocation tracking with camera verification checks.</p>
                    </div>
                </a>
            </div>
        </div>
