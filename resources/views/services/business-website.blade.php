    ...
    <section class="py-24 border-b border-outline-variant/20 bg-card/10">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 class="text-3xl lg:text-4xl font-bold text-white mb-6">How a Corporate Website Helps Your Business Grow Online</h2>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="p-8 rounded-2xl bg-card border border-border relative group">
                    ...
                    <h4 class="text-xl font-bold text-white mb-3">Establishes Institutional Authority</h4>
                ...
                <div class="p-8 rounded-2xl bg-card border border-border relative group">
                    ...
                    <h4 class="text-xl font-bold text-white mb-3">Automates Enterprise B2B Inquiries</h4>
                ...
                <div class="p-8 rounded-2xl bg-card border border-border relative group">
                    ...
                    <h4 class="text-xl font-bold text-white mb-3">Improves Stakeholder Transparency</h4>
    ...
    <section id="services" class="py-24 border-b border-outline-variant/20">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center max-w-3xl mx-auto mb-20">
                ...
                <h2 class="text-4xl font-bold text-white mb-6">Our Business Development Ecosystems</h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="p-8 rounded-2xl bg-card border border-border hover:border-primary/40 transition duration-300 flex flex-col justify-between">
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-white mb-3">Custom Corporate Portals</h3>
                ...
                <div class="p-8 rounded-2xl bg-card border border-border hover:border-primary/40 transition duration-300 flex flex-col justify-between">
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-white mb-3">B2B Lead Engines</h3>
                        <p class="text-on-surface/70 text-sm leading-relaxed">
                ...
                <div class="p-8 rounded-2xl bg-card border border-border hover:border-primary/40 transition duration-300 flex flex-col justify-between">
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-white mb-3">Multi-Branch Frameworks</h3>
                        <p class="text-on-surface/70 text-sm leading-relaxed">
                ...
                <div class="p-8 rounded-2xl bg-card border border-border hover:border-primary/40 transition duration-300 flex flex-col justify-between">
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-white mb-3">Bespoke CMS Architecture</h3>
                        <p class="text-on-surface/70 text-sm leading-relaxed">
                ...
                <div class="p-8 rounded-2xl bg-card border border-border hover:border-primary/40 transition duration-300 flex flex-col justify-between">
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-white mb-3">Platform Modernization</h3>
                        <p class="text-on-surface/70 text-sm leading-relaxed">
                ...
                <div class="p-8 rounded-2xl bg-card border border-border hover:border-primary/40 transition duration-300 flex flex-col justify-between">
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-white mb-3">Workflow Automation Sync</h3>
                        <p class="text-on-surface/70 text-sm leading-relaxed">
    ...
    <section class="py-24 border-b border-outline-variant/20">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 class="text-4xl font-bold text-white mb-6">Engineered for Operational Performance</h2>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="relative overflow-hidden p-6 rounded-2xl border border-border bg-card flex flex-col justify-between group">
                    <div>
                        ...
                        <h3 class="text-lg font-bold text-white mb-2">Enterprise-Grade Security</h3>
                ...
                <div class="relative overflow-hidden p-6 rounded-2xl border border-border bg-card flex flex-col justify-between group">
                    <div>
                        ...
                        <h3 class="text-lg font-bold text-white mb-2">Sub-Second Load Times</h3>
                        <p class="text-on-surface/70 text-xs sm:text-sm leading-relaxed">
                ...
                <div class="relative overflow-hidden p-6 rounded-2xl border border-border bg-card flex flex-col justify-between group">
                    <div>
                        ...
                        <h3 class="text-lg font-bold text-white mb-2">Advanced Schema Markup</h3>
                        <p class="text-on-surface/70 text-xs sm:text-sm leading-relaxed">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <a href="#" class="group rounded-2xl border border-border bg-card overflow-hidden transition-all hover:border-primary/30">
                    ...
                    <div class="p-8">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2 group-hover:text-primary transition-colors">Global Consultancy Hub</h3>
                ...
                <a href="#" class="group rounded-2xl border border-border bg-card overflow-hidden transition-all hover:border-primary/30">
                    ...
                    <div class="p-8">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2 group-hover:text-primary transition-colors">B2B Operations Portal</h3>
    ...
    <section class="py-24 border-t border-outline-variant/20 bg-card/10">
        <div class="max-w-4xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl font-bold text-white">Corporate Web Development Insights</h2>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-card p-6 sm:p-8 rounded-2xl border border-border">
                    ...
                    <p class="text-on-surface/70 pl-6 text-sm sm:text-base leading-relaxed">
                        A custom corporate website optimized for lead generation typically scales between <span class="text-white font-medium">6 to 10 weeks</span>. This roadmap spans strategy planning, bespoke responsive interface design, database architecture mapping, secure API integrations, and meticulous pre-launch quality assurance testing. More complex projects, such as centralized multi-branch franchise systems, can take <span class="text-white font-medium">12 weeks or more</span> depending on the specific scope.
                    </p>
                </div>
                ...
                <div class="bg-card p-6 sm:p-8 rounded-2xl border border-border">
                    ...
                    <p class="text-on-surface/70 pl-6 text-sm sm:text-base leading-relaxed">
                        Yes, our code is written from the ground up to maximize organic visibility. We optimize every template for Google's Core Web Vitals to achieve lightning-fast loading speeds, build fully mobile-responsive layouts, and inject validated <span class="text-white font-medium">Organization and LocalBusiness JSON-LD schema markup</span>. This structured data strategy makes it easy for search engine crawlers to understand your business layout, helping your branch locations rank higher in local and regional searches.
                    </p>
                </div>
            </div>
        </div>
