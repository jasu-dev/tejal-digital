        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-8">
                <div class="space-y-6">
                    ...
                    <p class="text-xl text-on-surface leading-relaxed max-w-lg">We create stunning websites, powerful
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm text-on-surface/80">{{ config('staticdata.clients') }}+ Happy Clients</span>
                </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-slate-900 rounded-lg p-4 font-mono text-sm">
                                <div class="text-blue-400">&lt;div className=<span
                                        class="text-green-400">"hero"</span>&gt;
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div
                                    ...
                                    <div class="text-2xl font-bold text-secondary-600">
                                        {{ config('staticdata.projects') }}+</div>
